...
<Accordion title="General" icon="gear" iconType="duotone">
  ...
  <Expandable title="Priority Options">
    - **Highest To Lowest**: Prioritizes blocks with highest value first.
    - **Lowest To Highest**: Prioritizes blocks with lowest value first.
    - **Titanium**: Prioritizes titanium blocks first.
    - **Normal**: Uses standard mining priority.
  </Expandable>
  - **Sneak While Mining**: Enables sneaking while mining blocks.
  - **Move Closer If Out of Range**: Automatically moves closer to blocks that are out of mining range.
  - **Move Closer Range**: Distance threshold for moving closer to blocks.
  ...
  - **Waypoint Mode**: Use custom waypoint roiutes for mining.
...
<Accordion title="Mining Ability" icon="pickaxe" iconType="duotone">
  ...
  - **Blue Cheese Swap**: Swaps to Blue Cheese item for specific mining situations.
