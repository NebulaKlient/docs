...
<Accordion title="General" icon="option" iconType="duotone">
  ...
  - **Use AOTE/AOTV**: Will utilize either ability if in hotbar to get to the next mob faster.
  - **Look for mobs**: Will imitate legit behaviour when no mobs are detected by looking around for the next mob.
  - **Mana Threshold**: 1-100%. Will stop using abilities after going under the set amount of mana percentage.
</Accordion>