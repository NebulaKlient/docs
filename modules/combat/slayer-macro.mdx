...
<Accordion title="General" icon="option" iconType="duotone">
  ...
  - **Daedalus Axe Swap On %HP**: Bosses health percentage threshold (1-100%) to switch to Daedalus Axe. At 10%, the macro will swap when the boos reaches 10% health or below.
</Accordion>

<Accordion title="Zombie Slayer" icon="biohazard" iconType="duotone">
  - **Dodge T5 TNT**: Automatically dodges TNT explosions during Tier 5 boss fights, instead of tanking attacks directly.
