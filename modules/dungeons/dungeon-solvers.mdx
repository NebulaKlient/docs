...
<Accordion title="Puzzles" icon="sparkles">
  - **Tic Tac Toe Solver**: shows the solution for TTT puzzle
  - **Auto Tic Tac Toe**: automatically completes TTT puzzle
  - **Blaze Solver**: shows the solution for Blaze puzzle
  - **Three Weirdos Solver**: shows the solution for Three Weirdos puzzle
  - **Auto Three Weirdos**: automatically completes Three Weirdos puzzle
  - **Ice Fill Solver**: shows the solution for Ice Fill puzzle
