...
<Accordion title="Farming" icon="farm" iconType="solid">
  ...
  - **Wilted Berberis Turbo Mode:** WIP gg
  - **Disable Turbo Mode Player Range:** Will disable the turbo mode if a player is within X blocks set on slider. If you put the slider to 0, turbo will not **turn on**.
